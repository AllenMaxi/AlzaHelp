...
curl -X GET "https://your-app.com/api/family" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X POST "https://your-app.com/api/family" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"name": "Test Family", "relationship": "test", "relationship_label": "Test", "category": "other"}'
```
